...
export const EXPORT_ALL_APIS = () => {
    ...
    const deleteInvestorContent = async (token, investorId) => {
        try {
            const response = await fetch(`${API_URL}/api/investorPage/${investorId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
    ...
    const updatePrivacyPolicy = async (token, data, policyId) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/privacy_policies/${policyId}`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const deletePrivacyPolicy = async (token, policyId) => {
        try {
            ...
            console.error(`Failed to delete privacy policy with ID ${id}:`, error.message);
    ...
    const deleteTermsOfUse = async (token, termsId) => {
        try {
            ...
            console.error(`Failed to delete Terms of Use with ID ${termsId}:`, error.message);
    ...
    const updateTermsAndConditions = async (token, data, termsId) => {
        try {
            const response = await fetch(`${API_URL}/api/terms_and_conditions/${termsId}`, {
                method: 'PUT',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
    ...
    const deleteTermsAndConditions = async (token, termsId) => {
        try {
            ...
            console.error(`Failed to delete Terms and Conditions with ID ${termsId}:`, error.message);
    ...
    const deleteAboutUs = async (token, aboutUsId) => {
        try {
            ...
            console.error(`Failed to delete About Us content with ID ${aboutUsId}:`, error.message);
...
const updateContactSeoData = async (token, data, contactSeoId) => {
    try {
        const response = await fetch(`${API_URL}/api/contactPageSeo/${contactSeoId}`, {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json',
...
const deleteContactSeoData = async (token, contactSeoId) => {
    try {
        ...
        console.error(`Failed to delete Contact SEO data with ID ${contactSeoId}:`, error.message);
...
const updateProductPage = async (token, data, productSeoId) => {
    try {
        const response = await fetch(`${API_URL}/api/productPage/${productSeoId}`, {
            method: 'PUT',
            headers: {
                'Authorization': `Bearer ${token}`,
                'Content-Type': 'application/json',
...
const deleteProductPage = async (token, productSeoId) => {
    try {
        ...
        console.error(`Failed to delete Product SEO data with ID ${productSeoId}:`, error.message);
