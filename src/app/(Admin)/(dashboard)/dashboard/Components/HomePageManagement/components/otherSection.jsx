      ...
      {showAddForm && (
        <form onSubmit={handleCreateContent}>
          ...
          <div className="form-section">
            ...
            />
            <input type="file" name="image_1_sec_3" onChange={handleChange} />
            <textarea
              name="disc_1_sec_3"
            ...
            />
            <input type="file" name="image_2_sec_3" onChange={handleChange} />
            <textarea
              name="disc_2_sec_3"
            ...
            />
            <input type="file" name="image_3_sec_3" onChange={handleChange} />
            <textarea
              name="disc_3_sec_3"
            ...
            />
            <input type="file" name="image_4_sec_3" onChange={handleChange} />
            <textarea
              name="disc_4_sec_3"
            ...
            />
            <input type="file" name="image_5_sec_3" onChange={handleChange} />
            <textarea
              name="disc_5_sec_3"
      ...
      {showEditForm && (
        <form onSubmit={handleUpdateContent}>
          ...
          <div className="form-section">
            ...
            <input type="file" name="image_2" onChange={handleUpdate} />
            {content.image_2 && (
              <img src={content.image_2} alt="Content Image 2" />
            )}
          </div>
          ...
          <div className="form-section">
            ...
            <input
              ...
              placeholder="Third Section Heading"
            />
            <input type="file" name="image_1_sec_3" onChange={handleUpdate} />
            {content.image_1_sec_3 && (
              <img src={content.image_1_sec_3} alt="Image 1 Sec 3" />
            )}
            <textarea
              name="disc_1_sec_3"
              ...
              placeholder="Description 1"
            />
            <input type="file" name="image_2_sec_3" onChange={handleUpdate} />
            {content.image_2_sec_3 && (
              <img src={content.image_3_sec_3} alt="Image 1 Sec 3" />
            )}
            <textarea
              name="disc_2_sec_3"
              ...
              placeholder="Description 2"
            />
            <input type="file" name="image_3_sec_3" onChange={handleUpdate} />
            {content.image_3_sec_3 && (
              <img src={content.image_3_sec_3} alt="Image 1 Sec 3" />
            )}
            <textarea
              name="disc_3_sec_3"
              ...
              placeholder="Description 3"
            />
            <input type="file" name="image_4_sec_3" onChange={handleUpdate} />
            {content.image_4_sec_3 && (
              <img src={content.image_4_sec_3} alt="Image 1 Sec 3" />
            )}
            <textarea
              name="disc_4_sec_3"
              ...
              placeholder="Description 4"
            />
            <input type="file" name="image_5_sec_3" onChange={handleUpdate} />
            {content.image_5_sec_3 && (
              <img src={content.image_5_sec_3} alt="Image 1 Sec 3" />
            )}
            <textarea
              name="disc_5_sec_3"
      ...
      {!showAddForm && !showEditForm && (
        <div>
          <div className="admin-homepage-seo">
            <h2>SEO Details</h2>
            <p>
              <strong>SEO Title:</strong> {fetchData.seo_title}
            </p>
            <p>
              <strong>SEO Description:</strong> {fetchData.seo_description}
            </p>
            <p>
              <strong>SEO Host URL:</strong> {fetchData.seo_host_url}
            </p>
          </div>
          <div className="admin-content-homepage">
            <h2>Content Details</h2>
            <p>
              <strong>Slider Heading:</strong> {fetchData.heading}
            </p>
            <p>
              <strong>Typing Heading:</strong> {fetchData.heading_nxt}
            </p>
            <p>
              <strong>Typing Heading 2:</strong> {fetchData.s_description_1}
            </p>
            <p>
              <strong>Typing Heading 3:</strong> {fetchData.s_description_3}
            </p>
            <h3>Slider Background</h3>
            {fetchData.image && (
              <img src={fetchData.image} alt="Content Image" />
            )}
            <p>
          ...
          <div className="admin-content-homepage">
            <h2>Third Section</h2>
            <p>
              <strong>Heading:</strong> {fetchData.heading_2}
            </p>
            ...
            <div
              dangerouslySetInnerHTML={{
                __html: fetchData.description_2 || "",
              }}
            />
            <h3>Image</h3>

            {fetchData.image_2 && (
              <img src={fetchData.image_2} alt="Content Image 2" />
            )}
          </div>
          <div className="admin-content-homepage">
            <h2>Third Section</h2>
            <p className="journey-heading-admin">
              <strong>Fourth Section Heading:</strong>{" "}
              {fetchData.third_sec_heading}
            </p>
            <div className="admin-journey-section">
              <div>
                <p>{fetchData.disc_1_sec_3}</p>
                {fetchData.image_1_sec_3 && (
                  <img src={fetchData.image_1_sec_3} alt="Image 1 Sec 3" />
                )}
              </div>
              <div>
                <p>{fetchData.disc_2_sec_3}</p>
                {fetchData.image_2_sec_3 && (
                  <img src={fetchData.image_2_sec_3} alt="Image 2 Sec 3" />
                )}
              </div>
              <div>
                <p>{fetchData.disc_3_sec_3}</p>
                {fetchData.image_3_sec_3 && (
                  <img src={fetchData.image_3_sec_3} alt="Image 3 Sec 3" />
                )}
              </div>
              <div>
                <p>{fetchData.disc_4_sec_3}</p>
                {fetchData.image_4_sec_3 && (
                  <img src={fetchData.image_4_sec_3} alt="Image 4 Sec 3" />
                )}
              </div>
              <div>
                <p>{fetchData.disc_5_sec_3}</p>
                {fetchData.image_5_sec_3 && (
                  <img src={fetchData.image_5_sec_3} alt="Image 5 Sec 3" />
                )}
              </div>
            </div>
          </div>
          <div className="journey-ed-del-btn">
            {fetchData ? (
              // If data exists, show Edit and Delete buttons
              <>
