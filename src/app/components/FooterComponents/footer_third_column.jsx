...
const FooterColumnThree = () => {
    const [footer, setFooter] = useState(null); // Initialize as null
    ...
    return (
        <div>
            {footer.column_3_heading_1 ? (
                <h2>{footer.column_3_heading_1}</h2>
            ) : (
                <p>No heading available</p>
            )}
            <ul>
                {footer.column_3_field_1 ? <li>{footer.column_3_field_1}</li> : <li>No field 1 available</li>}
                {footer.column_3_field_2 ? <li>{footer.column_3_field_2}</li> : <li>No field 2 available</li>}
                {footer.column_3_field_3 ? <li>{footer.column_3_field_3}</li> : <li>No field 3 available</li>}
            </ul>
        </div>
    );
};
